...
<br><br>
    ...
    <div class="container-fluid p-0 pb-5" style="background-color:rgb(133, 134, 136);"><center>
        ...
        <div class="" style="width:80%;height:90%;box-shadow: 0px 0px 2px 0px rgb(245, 244, 244);background: white;color: black">
            <h1> <a href="index.php"><img src="tangalogo.jpg" width="200" height="50"></a> |Amakuru Arambuye Amaze Igihe</h1>
             <?php 
        ...
        if (isset($_GET['id'])) {
          $id= $_GET['id'];
               ...
               $count = mysqli_num_rows($count_log);
                                  ...
                                  $sql = mysqli_query($conn, "SELECT * FROM news WHERE id='$id' AND status=1");
                                  $count =1;
                                    while ($row = mysqli_fetch_array($sql)) {
                                     
                                  ?>
                
                <img class="" src="logged/minubumwe/imagee/<?php echo $row['file'];?>" alt="" style="width: 70%; height: 60%;" >
