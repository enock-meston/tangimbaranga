...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index">Smart Meal Card</a>
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Recent Added Users
          <button onclick="window.location='addnewuser'" class="btn btn-primary px-3" style="float: right;"><i class="fa fa-plus"></i> Add New</button>
        </div>
        <div class="card-body">
              ...
              <tbody>
                <?php
                  if(isset($_GET['keyCode'])){
                    ...
                    $query = mysqli_query($connect,"SELECT * FROM leaders WHERE deleted = 0 AND leadernames LIKE '%$keyCode%' OR idcard LIKE '%$keyCode%' OR phone LIKE '%$keyCode%' OR district LIKE '%$keyCode%' OR sector LIKE '%$keyCode%' OR cell LIKE '%$keyCode%' OR village LIKE '%$keyCode%'");
                  }else{
                  ...
                  while ($row = mysqli_fetch_array($query)){
                    ...
                    echo"<tr>
                      ...
                      <td>".$row['phone']."</td>
                      <td>
                        <a href='editUser?userId=".$row['id']."'><button type='button' class='btn btn-primary'>Edit</button></a>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © Clemmence and Gentille 2022</small>
        </div>
      </div>
    </footer>
