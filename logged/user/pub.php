        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Publications Post</li>
                </ol>
                <!-- Icon Cards-->
                <div class="row">


                    <div class="col-xl-11 col-lg-12 stretch-card grid-margin"
                        style="height:910px; background:#F0F8FF;overflow-y: scroll">
                        <h4>Uploaded Publications from Different Areas</h4>
                        <?PHP 
              $select = mysqli_query($con,"SELECT * FROM publication");
            ...
            ?>
                        ...
                        <hr>
                        <center>
                            <div class="col-xl-8" style="height:600px;background:white;">
                                <img src="../minubumwe/<?php echo $row['thumbnail'];?>" style="width:100%; height:100%">

                            </div>
                        </center>
                        <center>
                            <div class="col-xl-8" style="height:300px;background:transparent;">

                                <h4>Title:<?php echo $row['title'];?><h4>
                                        <hr>
                                        <h5><?php echo $row['description'];?></h5>
                                        <h4>Creator:<?php echo $row['author'];?></h4>
                                        <h4>Date: <?php echo $row['creationdate'];?></h4>
