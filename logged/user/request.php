    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Testimony 
          <button onclick="window.location='addnewrequest'" class="btn btn-primary px-3" style="float: right;"><i class="fa fa-plus"></i> Add Testimony </button>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody >
                ...
                <?php
                  ...
                  $query = mysqli_query($connect,"SELECT * FROM requests WHERE cid = '".$_SESSION['smc_user']."' ORDER BY id DESC");
