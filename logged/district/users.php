    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Recent Added Sectors
          <button onclick="window.location='addnewuser'" class="btn btn-primary px-3" style="float: right;"><i class="fa fa-plus"></i> Add New Sector</button>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php
                  $sqli = mysqli_query($con,"SELECT * FROM `user` WHERE status=1 AND usertype='sec_user'");
                  $number=1;
