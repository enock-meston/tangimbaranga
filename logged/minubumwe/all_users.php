            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <button onclick="window.location='addnewuser'" class="btn btn-primary px-3"
                            style="float: right;"><i class="fa fa-plus"></i> Add New District</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                  $sqli = mysqli_query($con,"SELECT * FROM `user` WHERE status=1");
                  $number=1;
                ...
                ?>
                      ...
                      ?>
                                        ...
                                        <td>
                                            <a href="users?idedit=<?php echo $row['userid'];?>"
                                                class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                            <a href="user?iddelete=<?php echo $row['userid'];?>"
