...
if (isset($_POST['addNewUser'])) {
  ...
  if ($countemail > 0) {
    ...
    if ($query) {
      ...
      $message = "Hello $names, your account has been Approved successfully, you can login as other user on 
      <a href='http://localhost/tangimbaraga/logged/'>login</a>
      . Your login details are as follows: Email: $email, Password: $pass";
      $to = $email;
      send_mail($subject,$message,$to);
      $msg = "User added successfully!";
      mysqli_query($con,"UPDATE `otherinstitutionrequest` SET `status`='1' WHERE id='$userid'");
    }else{
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        if (isset($_GET['id'])) {
          $id= $_GET['id'];
               ...
               $count_log=mysqli_query($con,"select * from otherinstitutionrequest where id='$id'");
               $count = mysqli_num_rows($count_log);
        
              $members_query = mysqli_query($con,"select * from otherinstitutionrequest where id='$id'")or die(mysqli_error());
                        ...
                        <form method="POST">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select readonly class="form-control" name="province" required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input readonly type="text" class="form-control" name="dis" required>
                                </div>


                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Sector</label>
                                    <input readonly type="text" class="form-control" name="sec" required>
                                </div>


                                <div class="form-group col-md-6">
                                    <label for="inputZip">Cell</label>
                                    <input readonly type="text" class="form-control" name="cell" required>
                                </div>


                                <div class="form-group col-md-6">
                                    <label for="inputZip">Village</label>
                                    <input readonly type="text" class="form-control" name="village" required>
                                </div>
