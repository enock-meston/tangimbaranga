...
date_default_timezone_set("Africa/Kigali");
    ...
    $query = mysqli_query($connect, "SELECT * FROM citizen WHERE deleted = 0");
    $c_count = mysqli_num_rows($query);

    $query = mysqli_query($connect, "SELECT * FROM requests");
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><?php echo $c_count; ?> Citizen</div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><?php echo $r_count; ?> All Requests</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="requests">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><?php echo $ar_count; ?> Approved Requests</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="approved">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-dark o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"><?php echo $rr_count; ?> Rejected Requests</div>
            </div>
