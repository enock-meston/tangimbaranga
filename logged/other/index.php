...
error_reporting(0);
if (strlen($_SESSION['other_id']) == 0) {
    header('location: ../index.php');
} else {
  $me = $_SESSION['other_id'];
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-dark o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo "2"; ?>Citizens</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-dark o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo "2"; ?> publications</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-dark o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo "2"; ?> events </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-dark o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?php echo "2"; ?> Rejected events</div>
                            </div>
