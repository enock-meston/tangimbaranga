...
date_default_timezone_set("Africa/Kigali");
    ...
    $query = mysqli_query($connect,"SELECT * FROM citizen WHERE id='".$_GET['userId']."'");
    $upInfo = mysqli_fetch_array($query);
?>
<!DOCTYPE html>
<html lang="en" >
<head>
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-edit"></i> Edit Citizen
        </div>
        <div class="card-body">
          <?php
            echo"<form method='POST' action='../server.php'>
              <div class='form-row'>
                <div class='form-group col-md-6'>
                  ...
                  <input type='hidden' class='form-control' name='id' required value='".$upInfo['id']."'>
                  <input type='text' class='form-control' name='name' required value='".$upInfo['name']."'>
                </div>
                <div class='form-group col-md-6'>
                  <label for='inputPassword4'>Gender</label>
                  <select class='form-control' name='gender' required>
                    <option>".$upInfo['gender']."</option>
                    <option>Male</option>
              ...
              <div class='form-row'>
                <div class='form-group col-md-6'>
                  ...
                  <input type='number' class='form-control' name='phone' required value='".$upInfo['phone']."'>
                </div>
                <div class='form-group col-md-6'>
                  <label for='inputCity'>Age</label>
                  <input type='number' class='form-control' name='age' required value='".$upInfo['age']."'>
                </div>
                <div class='form-group col-md-6'>
                  <label for='inputCity'>Address</label>
                  <input type='text' class='form-control' name='address' required value='".$upInfo['address']."'>
                </div>
              </div>
              <button type='submit' class='btn btn-primary' name='editUser'><i class='fa fa-save'></i> Save Changes</button>
            </form>";
          ?>
        </div>
      </div>
